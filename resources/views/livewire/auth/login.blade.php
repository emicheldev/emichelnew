...
<div>
    ...
    <div class="">
        <div class=" text-center">
            <span class="text-sm  font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150"> Inscrivez-vous avec </span>
        </div>
        <div class="flex">
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start text-gray-500">
                <a class="" href="{{ url('login/github') }}" rel="noopener noreferrer" target="_blank">
                ...
                <a class="" href="{{ url('login/facebook') }}" rel="noopener noreferrer" target="_blank">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                    </svg>
                  </a>
                <a class="ml-3 " href="{{ url('login/google') }}"" rel="noopener noreferrer" target="_blank">
                ...
                <a class="ml-3 " href="{{ url('login/linkedin') }}"" rel="noopener noreferrer" target="_blank">

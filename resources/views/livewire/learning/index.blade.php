      ...
      <div class="flex flex-wrap py-8 text-sm">
        <div class="flex flex-col flex-shrink-0 w-full h-screen mb-6 overflow-y-auto scrolling-touch sm:w-1/6 md:mb-0">
          ...
          <div class="flex flex-col ">
              ...
              <label class="inline-flex items-center mb-2 ">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">Laravel(7)</span>
              </label>
              <label class="inline-flex items-center mb-2 ">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">Symfony(27)</span>
              </label>
              <label class="inline-flex items-center mb-2 ">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">Slim(1)</span>
              </label>
              <label class="inline-flex items-center mb-2 ">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">PHPUnit(27)</span>
              </label>
              <label class="inline-flex items-center mb-2 ">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">Laravel(7)</span>
              </label>
              <label class="inline-flex items-center mb-5">
                  <input type="checkbox" class="w-5 h-5 text-blue-600 form-checkbox" ><span class="ml-2 text-gray-700 ">Symfony(2)</span>
              </label>        
          </div>
        </div>
        ...
        <div class="w-full pl-4 sm:w-5/6">
          ...
          <div class="flex flex-wrap gap-y-8">
            ...
            @for ($i=1; $i<=8; $i++)
             ...
             <a href=" {{ route('course_show') }} ">
              <div class="flex flex-col w-full px-2 sm:w-1/2 md:w-1/3 ">
                <img loading="lazy" class="w-full rounded-lg" src="https://i.ytimg.com/vi/RIU5jVaXzEw/maxresdefault.jpg" alt="">
                ...
                <div class="flex items-center text-xs">
                  <div class="flex items-center mr-4 ">
                    ...
                    <a class="" href=" {{ route('course') }} ">9 Lessons </a>
                  </div>

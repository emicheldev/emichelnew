<div>
    ...
    <h3 class="text-3xl font-semibold text-gray-700">Ajout d'article </h3>
    <div>
                ...
                <form wire:submit.prevent="savePost">
                    ...
                    <div class="block">
                        ...
                        <label class="inline-flex items-center">
                            <input type="checkbox" class="border form-checkbox" wire:model="tags_id" name="tags[] " value="{{$id}}">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <input class="w-full mt-2 border rounded-md form-input focus:border-indigo-600" type="text" placeholder="url of post image" wire:model='image'>
                    ...
                    <label class="block">
                        <textarea id="content" class="block w-full mt-1 text-gray-900 border form-textarea" rows="5" placeholder="Enter content." wire:model='content'></textarea>

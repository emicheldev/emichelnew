      ...
      <div class="flex flex-wrap md:text-left text-center order-first text-white ">
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav class="list-none mb-10 text-sm">
            <li>
              <a class=" hover:text-gray-800">Accueil</a>
            </li>
            <li>
              <a class=" hover:text-gray-800">s'inscrir</a>
            </li>
            <li>
              <a class=" hover:text-gray-800">Tarif</a>
            </li>
            <li>
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Cours</h2>
          <nav class="list-none mb-10 text-sm">
            <li>
              <a class=" hover:text-gray-800">Bases de Php</a>
            </li>
            <li>
              <a class=" hover:text-gray-800">Créer une Api avec Laravel </a>
            </li>
            <li>
              <a class=" hover:text-gray-800">Essentiet en CSS</a>
            </li>
            <li>
              <a class=" hover:text-gray-800">Les dates en PHP</a>
            </li>
          </nav>
        </div>
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <div class="flex xl:flex-no-wrap md:flex-no-wrap lg:flex-wrap flex-wrap justify-center md:justify-start">
            <input class="text-gray-900 w-40 sm:w-auto bg-gray-100 rounded xl:mr-4 lg:mr-0 sm:mr-4 mr-2 border border-gray-400 focus:outline-none focus:border-indigo-500 text-base py-2 px-4" placeholder="Placeholder" type="text">
          </div>
          <p class="text-gray-100 text-sm mt-2 md:text-left text-center">Vous recevriez les informations
            <br class="lg:block hidden">et des postes 
          </p>
        </div>
      </div>
    </div>
    <div class="bg-gray-200">
      <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span class="ml-3 text-xl">emichel</span>
        </a>
        <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2020 emichel —
          <a href="https://twitter.com/emichel_dev" rel="noopener noreferrer" class=" ml-1" target="_blank">@emichel_dev</a>
        </p>
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start text-gray-500">
          <a class="" href="" rel="noopener noreferrer" target="_blank">
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
              <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
            </svg>
          </a>
          <a class="ml-3 " href="" rel="noopener noreferrer" target="_blank" >
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">

    ...
    <div class="max-w-6xl py-24 mx-auto ">
      <div class="flex flex-wrap order-first text-center text-white md:text-left ">
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-900 title-font">SITE</h2>
        ...
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-900 title-font">Cours</h2>
          <nav class="mb-10 text-sm list-none">
            <li>
        ...
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-900 title-font">Support</h2>
          <nav class="mb-10 text-sm list-none">
            <li>
        ...
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-900 title-font">NEWSLETTER</h2>

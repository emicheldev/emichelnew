...
<div class=" text-gray-200 bg-gray-900">
   <section class="max-w-6xl mx-auto px-6 element">
        ...
        <h1>The right way to sell <span class="typed"></span></h1>
   </section>
          ...
          <div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
            <div class="pattern-dots-md gray-light">
              <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6  "  >
                ...
                <div class="flex-grow ">
                  <h2 class=" text-xl title-font font-medium mb-3">Webdesign</h2>
                  <p class="leading-relaxed text-sm text-justify">Donner du goût 😍 de la couleur  aux applications, je le fais à fin de rendre vos sites atraiyands 🎨. Avant d'être webdesigner depuis tout petit, j'étais déjà familier à la couleur et du dessin.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="pattern-dots-md gray-light">
              <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                ...
                <div class="flex-grow">
                  <h2 class=" text-xl title-font font-medium mb-3">Developpement Back-end</h2>
                  <p class="leading-relaxed text-sm text-justify">
                   Grâce à Php et ces frameworks(Larave, Symfoni, Slim), je peux vous réaliser un site dynamique c'est à dire qui interagie avec votre base de donnée 💪.
...
<script>
  ...
  new Typed ('.typed', {
  strings: ["First phrase.", "<span class='text-red-500'>Second phrase.</span> "],
 	typeSpeed: 100,
					loop: true,
					startDelay: 1000,
					backDelay: 1000,
  fadeOut: true,
				...
				// $(".typed").typed({
				// 	strings: ["code", "snippets", "themes", "libraries", "plugins", "packages", "templates", "modules"],
				// 	typeSpeed: 100,
				// 	loop: true,
				// 	startDelay: 1000,
				// 	backDelay: 1000
